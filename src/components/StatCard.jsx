...
export function StatCard({ icon: Icon, label, value, tone = 'slate' }) {
  const tones = {
    slate: {
      icon: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/70 dark:text-emerald-300',
  ...
  return (
    <motion.div
      ...
      className={`overflow-hidden rounded-lg border border-emerald-100 bg-white p-4 shadow-[0_12px_30px_rgba(15,118,110,0.08)] dark:border-slate-700 dark:bg-slate-800/85 ${activeTone.glow}`}
    >
