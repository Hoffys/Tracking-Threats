...
The extension scans visited HTTP/HTTPS pages, supported search results, and supported webmail pages. Do not publish it without clear user consent and privacy wording.
